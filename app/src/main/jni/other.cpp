...
JNIEXPORT void JNICALL Java_com_lasarobotics_ftc_camera_detection_ObjectDetection_findObject(JNIEnv *env, jobject type, jlong addrGrayObject, jlong addrGrayScene) {
